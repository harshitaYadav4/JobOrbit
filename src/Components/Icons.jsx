...
// Reusable SVG icon components — replaces all emojis
...
export const IconDollar = ({ size = 20, color = 'currentColor' }) => (
  <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IconTractor = ({ size = 20, color = 'currentColor' }) => (
  <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M3 17h1m0 0a3 3 0 1 0 6 0m-6 0a3 3 0 1 0 6 0m-2-8V6a1 1 0 0 1 1-1h3l2 3h3a1 1 0 0 1 1 1v3"/><circle cx="17" cy="17" r="3"/><path d="M14 17h-4"/>
  </svg>
);

export const IconScale = ({ size = 20, color = 'currentColor' }) => (
  <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 3v18"/><path d="M3 7l9-4 9 4"/><path d="M3 7l3 6h6L9 7"/><path d="M15 7l3 6h-6l3-6"/>
  </svg>
);
...
export const IconHardHat = ({ size = 20, color = 'currentColor' }) => (
  <svg style={s} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M2 18a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v2z"/><path d="M10 15V6.5a2 2 0 0 1 4 0V15"/><path d="M4 15v-3a8 8 0 0 1 16 0v3"/>
  </svg>
);
